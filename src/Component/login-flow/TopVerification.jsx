            ...
            <div className='w-full max-w-[1300px] sm:pb-9 pb-7 mx-auto sm:px-0 px-4 pt-14'>
                ...
                <div className="h-auto flex  justify-center pt-14">
                    <div className="bg-white shadow-[0px_4px_10px_0px_#2323231A] border border-[#E9E9E9] rounded-2xl sm:px-12 px-3 w-full max-w-[590px] p-8">
                        <h1 className="sm:text-3xl text-2xl SF_Pro font-bold mb-1 text-gray-800">OTP Verification</h1>
                        <p className="text-[#2B2A29] text-sm mb-6">We sent a code {email}</p>
                            ...
                            <div className="flex gap-4 mb-6">
                                {otp.map((value, index) => (
                                    <input
                                        ...
                                        className="w-12 h-12 text-center text-lg border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    />
                                ))}
                            </div>
                            <div className='pt-5'>
