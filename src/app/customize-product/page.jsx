...
import { PiPlus, PiShoppingCart } from 'react-icons/pi'
...
const customizeProduct = () => {
    const Best_seller = [
        {
            image: "/assets/images/customize-product.png",
            ...
            <div className='w-full max-w-[1200px] mx-auto sm:px-0 px-4 z-10'>
                ...
                <div className='sm:flex grid flex-wrap items-center gap-5 sm:pt-10 pt-7'>
                    {Best_seller.map((item, i) => (
                        <div className='h-auto w-auto bg-[#F6F6F6] rounded-[20px] pr-3.5 pt-2 pl-[23px] pb-[15px]' key={i}>
                            <Image
                                src={item?.image}
                                alt='Best Seller'
                                height={200}
                            ...
                            <div className='flex items-end justify-between'>
                                <div>
                                    ...
                                    <p className='pt-[2px] text-[#2B2A29] text-sm_40/5'>{item?.Stock}</p>
                                    <p className='pt-4 text-xl_36 text-[#2B2A29] font-bold'>₹ {item?.price || '0.00'}</p>
                                </div>
                                <Link
